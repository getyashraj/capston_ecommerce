...
const Navbar = ({ isAuthenticated, logout, Cartvalue, Wishlistvalues }) => {
  ...
  return (
    <div>
            ...
            <div class="col-xl-7 col-lg-12">
              <nav class="header__menu">
                <ul>
                  ...
                  <li>
                    <Link to="/products/woman">Women’s </Link>
                  </li>
                  <li>
                    <Link to="/products/man">Men’s </Link>
                  </li>
                  <li>
                    <Link to="/products/kid">Kid’s </Link>
                  </li>
                  <li>
                    <Link to="/products/cosmetic">Cosmetic's </Link>
                  </li>
                  <li>
      ...
      <div
        class={
          sidebar ? "offcanvas-menu-wrapper active" : "offcanvas-menu-wrapper"
        }
      >
